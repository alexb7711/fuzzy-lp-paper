...
\label{sec:org57be1b8}
\section{Preliminaries}
\label{sec:org3c000fe}
\subsection{Mixed Integer Linear Program}
\label{sec:orga54a4fc}
...
fuzzified terms. \ref{subeq:fp_binaryspace} simply updates the binary decision term.
