...
\label{sec:org683859f}
\section{Preliminaries}
\label{sec:orga1b6172}
\subsection{Mixed Integer Linear Program}
\label{sec:org72ccaa9}
...
rationality, and robustness (Mariano Jim{\'e}nez and Mar Arenas and Amelia Bilbao and M. Victoria Rodr ´guez, 2007, Marilyn Bello and Gonzalo N{\'a}poles and Ivett Fuentes and Isel Grau and Rafael Falcon and Rafael Bello and Koen Vanhoof, 2019, Jagdeep Kaur and Amit Kumar, 2016). These
...
handling time, \(\tilde{p}\), are assumed to be imprecise. The objective of the model is to allocate all the vessels to
...
notation of (, , Marilyn Bello and Gonzalo N{\'a}poles and Ivett Fuentes and Isel Grau and Rafael Falcon and Rafael Bello and Koen Vanhoof, 2019) while attempting to remain as consistent as possible with
the notation presented in this paper. In this section, \(Q\) refers to the set of quays. Furthermore, the model is defined
...
v_{iq} + l_i \le v_{jq} + M(1-\sigma_{ijq}^x)                         & \forall i,j \in I;\; i \ne j;\; \forall q \in Q                         \\
\tilde{u}_{iq} + \tilde{s}_i \le T                               & \forall i \in I;\; \forall q \in Q                                    \\
\tilde{u}_{iq} + \tilde{s}_i \le \tilde{u}_{iq + M(1-\psi{ijq}^y)} & \forall i,j \in I;\; i \ne j;\; \forall q \in Q                         \\
\end{array}
\end{equation}

One may note the similarities to the previously presented BAB and PAP models in \ref{eq:fuzzy-bap}. It is, however, not
exactly defined in a way useful to the purposes of this paper. The adaptation of the Fuzzy BAP (FBAP) is discussed next.

\section{Fuzzy PAP}
\label{sec:org6b437d4}

\section{References}
\label{sec:orgfe777d0}
\noindent
...
\noindent
Mariano Jim{\'e}nez and Mar Arenas and Amelia Bilbao and M. Victoria Rodr ´guez (2007). \emph{Linear Programming With Fuzzy Parameters: an Interactive Method Resolution}, European Journal of Operational Research.
