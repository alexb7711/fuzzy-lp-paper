...
\label{sec:org3d5d762}
\section{Preliminaries}
\label{sec:orgb5f9fe2}
\subsection{Mixed Integer Linear Program}
\label{sec:org8b4e704}
...
\label{sec:org727b11a}
For the queuing constraints, lets begin with the set of crisp constraints that are of interest
...
\end{equation}
\begin{equation}
   \sigma_{ij}, \psi_{ij} \in \{0,1\}\;            \label{subeq:binaryspace}        \\
\end{equation}
\begin{equation}
    v_i, q_i \in  \mathbb{Q}                                         \label{subeq:Qspace}        \\
\end{equation}
