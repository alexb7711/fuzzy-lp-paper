...
\label{sec:orgc1dc275}
\section{Preliminaries}
\label{sec:org1e1ea7b}
\subsection{Mixed Integer Linear Program}
\label{sec:org77f14c9}
...
converted into crisp constraints, the constraint validity is maintained \cite{ghanbari-2019-fuzzy}.
