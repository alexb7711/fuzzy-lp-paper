...
[[fig:characteristic-plot]] demonstrates a membership function of a triangular fuzzy number. For a formal definition,
...
([[fig:characteristic-plot]]). The triangular fuzzy numbers shall also be defined over the set of real numbers $\mathbb{R}$. Consider
...
if its membership function is defined as [[eq:triangular-fuzzy-number]]. [[fig:characteristic-plot]] depicts a visual
