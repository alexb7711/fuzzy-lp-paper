...
[[fig:characteristic-plot]] demonstrates a membership function of a triangular fuzzy number. As a formal definition,
consider the following:

#+name: fig:characteristic-plot
#+caption: Example plot of a characteristic function for a triangular fuzzy number.
#+ATTR_LATEX: :width 0.5\textwidth
[[../img/characteristic-plot.pdf]]
