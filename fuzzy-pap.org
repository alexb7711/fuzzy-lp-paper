...
\begin{subequations}
                                                     \label{eq:dynconstrs}
\begin{equation}
    \tilde{u}_i - \tilde{u}_j - \tilde{s}_j - (\tilde{\sigma}_{ij} - 1)T \geq 0              \label{subeq:m_time}         \\
\end{equation}
\begin{equation}
    v_i - v_j - (\psi_{ij} - 1)n_Q \geq 1                  \label{subeq:m_space}        \\
\end{equation}
\begin{equation}
    \tilde{\sigma}_{ij} + \tilde{\sigma}_{ji} + \psi_{ij} + \psi_{ji} \geq 1            \label{subeq:m_valid_pos}    \\
\end{equation}
\begin{equation}
    \tilde{\sigma}_{ij} + \tilde{\sigma}_{ji} \leq 1                              \label{subeq:m_sigma}        \\
\end{equation}
\begin{equation}
