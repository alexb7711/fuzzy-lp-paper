...
Consider the following non-negative triangular fuzzy FFLP show in \ref{eq:fflp-example}.
...
to ensure the triangular fuzzy numbers are valid. \ref{eq:fflp-example-crisp} is now said to be a crisp representation of
\ref{eq:fflp-example}. Solving the FFLP utilizing the Octave LP module, the example problem has a solution of TODO: SOLUTION
HERE.
