...
\label{sec:orgf815b3c}
\section{Preliminaries}
\label{sec:orgc12b83c}
\subsection{Mixed Integer Linear Program}
\label{sec:orgfc3ecdb}
...
is discussed next in \ref{sec:the-fuzzy-pap}. An example solution of \ref{eq:fuzzy-bap} for 2 quays, provided by
